...
public class MainClass09 {
	...
	/*
	 *  List<Map<String, Object>> type 을 전달 받는
	 *  static 멤버 메소드를 만들어 보세요.
	 */
	
	public static void printMembers(List<Map<String, Object>> arg) {
		/*
		 *  인자로 전달받은 arg 에 있는 참조값을 이용해서
		 *  
		 *  회원정보를 아래와 같은 형식으로 출력해 보세요.
		 *  
		 *  번호: 1, 이름: 김구라, 주소: 노량진
		 *  번호: 2, 이름: 해골, 주소: 행신동
		 */
		for(int i = 0; i < arg.size(); i++) {
			...
			//Map 에 저장된 data 불러오기
			int num = (int)tmp.get("num");//Object 이기 때문에 반드시 String 으로 casting 해 줘야 함!
